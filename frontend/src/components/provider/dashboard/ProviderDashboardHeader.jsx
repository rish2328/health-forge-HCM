        ...
        <Paper elevation={0} sx={{ p: 3, mb: 3, border: "1px solid #E5E7EB", borderRadius: 2 }} >
            <Grid container spacing={3} alignItems="center">
                ...
                <Grid size={{ xs: 12, md: 1.5 }}>
                    <Avatar sx={{ width: 90, height: 90, bgcolor: "primary.main", fontSize: 32, fontWeight: 700 }} > {provider?.first_name?.charAt(0)} </Avatar>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 8 }}>
                    ...
                    <Stack direction="row" spacing={1} mt={1} flexWrap="wrap">
                        <Chip label={provider?.department_name} color="primary" size="small" />
                        <Chip label={provider?.role_name} color="secondary" size="small" />
                        <Chip label={provider?.status ? "Active" : "Inactive"} color={provider?.status ? "success" : "error"} size="small" />
                    </Stack>
                    ...
                    <Stack direction="row" spacing={4} mt={3} flexWrap="wrap">
                        ...
                        <Stack direction="row" spacing={1} alignItems="center">
                            ...
                            <Typography variant="body2"> {provider?.license_number || "-"} </Typography>
                        </Stack>
                    </Stack>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 2.5 }} textAlign="right">
                    <Button variant="outlined" startIcon={<ArrowBackIcon />} onClick={() => navigate("/providers")} > Back </Button>
                </Grid>
            </Grid>
        </Paper>
    );
